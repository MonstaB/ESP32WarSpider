...
New v 0.0.11✅ write manual sessions and WiGLE CSV
...
v0.0.17     GPS snapshot attached to observations

v0.0.18     Observation + GPS association

v0.0.19     Basic session UI

v0.0.20     Session close

v0.0.21     Clean shutdown / session finalisation

v0.0.22     End-to-end field test and fixes
...
Automatic uploading remains outside v0.1.0; 

manual removal/upload of the CSV is supported from the first field-capable release.
